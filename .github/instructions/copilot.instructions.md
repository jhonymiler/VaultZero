...
## Comunicação e Tom
- Para conversas com desenvolvedores/arquitetos: use tom casual, direto e técnico
- Seja honesto sobre limitações técnicas reais do projeto
- Baseie respostas no código real existente, mas **evite mostrar código** - explique com exemplos conceituais
- Reconheça quando algo não é tecnicamente possível de resolver
- Use explicações práticas em vez de blocos de código
- Mantenha respostas concisas, evitando redundâncias
